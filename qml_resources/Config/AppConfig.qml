...
QtObject {
    ...
    readonly property int activityContainerMaxWidthRoomTemp: 420
    readonly property int activityContainerMaxWidthCryoTemp: 480
    ...
    // Argon purge activity parameters
    // The pressure setpoints (30/15/10 Pa) are fixed in the backend
    // (defaults.py); only the cycle count and chamber recovery are
    // user-facing. Recovery reuses the shared chamberRecoverySpinBox*
    // bounds above.
    readonly property int argonPurgeCyclesDefault: 0
    readonly property int argonPurgeCyclesMin: 0
    readonly property int argonPurgeCyclesMax: 20

    // Pressure chart (Argon Purge live chamber-pressure plot)
    // Canvas line chart: pressure (Pa, y) vs elapsed time (s, x).
    readonly property color pressureChartPlotBackground: universalBackground
    readonly property color pressureChartChromeColorActive: universalForeground
    readonly property color pressureChartChromeColorInactive: textDisabledColor
    ...
    // Chart title: same family/color as the tick labels, a step larger.
    readonly property int pressureChartTitleFontPx: 15
    readonly property real pressureChartTraceWidth: 2
    readonly property real pressureChartMarginLeft: 68
    readonly property real pressureChartMarginBottom: 42
    // Top margin holds the centered chart title; sized to fit the title band.
    readonly property real pressureChartMarginTop: 28
    readonly property real pressureChartMarginRight: 12
    readonly property real pressureChartTickGap: 6
    ...
    readonly property real stageTiltAngleMin: -14.0
