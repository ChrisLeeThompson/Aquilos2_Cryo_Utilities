...
QtObject {
    ...
    readonly property string gisPurgeDurationLabelTooltip: "GIS valve will open and purge for the specified duration (seconds)."
        ...
        // Argon purge activity
    readonly property string argonPurgeActivityTooltip: "Cycles the chamber vacuum with argon to purge the argon lines and reduce ice contamination before cryo work."
    readonly property string argonPurgeCyclesLabelTooltip: "Number of argon purge cycles (each pumps to 30 Pa then 15 Pa). 0 runs only the final 10 Pa step."

        // Pressure chart (Argon Purge)
    readonly property string pressureChartTitle: "Chamber Pressure"
    readonly property string pressureChartXAxis: "Time (s)"
    readonly property string pressureChartYAxis: "Pressure (Pa)"
    readonly property string pressureChartWaiting: ""
    ...
    readonly property string sputterCoatActivityTooltip: "Sputter coats both grid 1 and grid 2 with the magnetron Pt sputter coater."
    readonly property string sputterCoatCurrentLabelTooltip: "Sputter current (milliamperes)."
    readonly property string sputterCoatPressureLabelTooltip: "Target chamber pressure (pascals) for the argon sputter plasma."
    readonly property string sputterCoatDurationLabelTooltip: "Sputter coat duration (seconds)."

        // GIS deposition activity
    readonly property string positionLabelTooltip: "Stage position to move to for GIS deposition."
