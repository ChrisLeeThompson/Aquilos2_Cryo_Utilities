...
QtObject {
    ...
    readonly property string argonPurgeCyclesLabelTooltip: "Number of argon purge cycles; each pumps to 30 Pa, then 15 Pa. Set to 0 to run only the final 10 Pa step."
    ...
    readonly property string sputterCoatActivityTooltip: "Sputter coats grids 1 and 2 with the magnetron Pt sputter coater."
    readonly property string sputterCoatCurrentLabelTooltip: "Sputter current (mA)."
    readonly property string sputterCoatPressureLabelTooltip: "Target chamber pressure (Pa) for the argon sputter plasma."
    readonly property string sputterCoatDurationLabelTooltip: "Sputter coat duration (s)."

        // GIS deposition activity
    readonly property string positionLabelTooltip: "Stage position used for the GIS deposition."
