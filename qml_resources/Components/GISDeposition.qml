...
GroupBox {
    ...
    // every box to the group max so they line up. (The position ComboBox sets
    // its own width and is not part of this group.) Loop-safe because
    // implicitWidth doesn't depend on preferredWidth/width.
