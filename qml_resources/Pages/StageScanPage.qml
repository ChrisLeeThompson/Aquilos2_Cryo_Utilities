...
import Aquilos2.Microscope 1.0
import "../Config"
import "../Components"
import "../Effects"
    ...
    ColumnLayout {
        ...
        Label {
            ...
            text: "These functions can be used to rotate the stage 180°, scan rotate the SEM and FIB, and adjust the stage z height (with Z-Y Link enabled)."
                  + "<br><br><b>Note:</b> the stage rotation and z height functions are not aware of the position of the stage relative to the SEM or FIB polepieces."
