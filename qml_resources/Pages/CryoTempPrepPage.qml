...
Item {
    ...
    Component {
        ...
        Item {
            ...
            // for the "wrong" activity type (e.g. sputterCurrentMa on a
            ...
            // irrelevant roles; QML's `required property int` accepts 0.
            required property int sputterCurrentMa
            required property int sputterPressurePa
            ...
            Component {
                ...
                SputterCoat {
                    ...
                    current: delegateRoot.sputterCurrentMa
                    pressure: delegateRoot.sputterPressurePa
