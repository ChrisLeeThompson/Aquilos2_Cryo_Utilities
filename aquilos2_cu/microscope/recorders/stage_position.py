...
--------------------------------------
This recorder captures one atomic value — the object returned by
``stage.current_position`` — and replays it unchanged to
``stage.absolute_move``, rather than decomposing it into scalar
fields. Two reasons:
