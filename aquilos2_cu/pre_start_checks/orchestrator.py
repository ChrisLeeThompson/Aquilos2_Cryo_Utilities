...
class PendingStart:
    ...
    consumers (:mod:`aquilos2_cu.workflows.runner` and
    :mod:`aquilos2_cu.stage_scan.controller`) until a third
    consumer (:mod:`aquilos2_cu.stage_positions.controller`)
...
def to_dialog_items(
    ...
    :class:`~aquilos2_cu.stage_scan.controller.StageScanController`,
    :class:`~aquilos2_cu.stage_positions.controller.StagePositionsController`)
