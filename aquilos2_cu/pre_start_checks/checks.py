...
:mod:`aquilos2_cu.pre_start_checks.snapshot`.
...
def is_within_safe_range(stage_x_m: float, stage_y_m: float) -> bool:
    ...
    (:data:`aquilos2_cu.defaults.STAGE_SAFE_RADIAL_RANGE_M`) and both
...
class StagePositionWithinSafeRangeCheck(PreStartCheck):
    ...
    The threshold is defined in :mod:`aquilos2_cu.defaults`:
    ...
    * The stage's radial distance from chamber center
    ...
    :mod:`aquilos2_cu.defaults` ("8 mm" includes the endpoint)
