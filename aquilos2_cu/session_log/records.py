...
* :class:`ActivityLogEntry` — written once per activity finish. Carries
  ...
  :meth:`aquilos2_cu.activities.base.ActivityService.parameter_summary`.
...
on it. This mirrors :func:`aquilos2_cu.cryo.activity_records.record_from_dict`
...
:data:`aquilos2_cu.cryo.activity_records.ActivityRecord`.
...
class SessionBeginEntry:
    ...
    def from_dict(cls, d: Dict[str, Any]) -> "SessionBeginEntry":
        ...
        :meth:`aquilos2_cu.cryo.activity_records.SputterCoatRecord.from_dict`.
        """
