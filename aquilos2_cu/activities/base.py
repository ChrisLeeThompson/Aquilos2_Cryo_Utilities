...
# our code (e.g. AutoScript home(), sputter_coater.run()). The
...
class ActivityService(ABC):
    ...
    # orchestrator in :mod:`aquilos2_cu.pre_start_checks`.
    #
    ...
    def pre_start_checks(cls) -> List[PreStartCheck]:
        ...
        :class:`~aquilos2_cu.pre_start_checks.snapshot.HardwareSnapshot`.
    ...
    #
    # Consumed by the SessionLog (see :mod:`aquilos2_cu.session_log`).
