...
GIS Deposition does not modify ion beam state. (Neither does the
Aquilos 2 magnetron Sputter Coat — it's driven by the sputter coater
and vacuum system, not the ion beam — so no ion-beam recorder exists
in this app.)
"""
